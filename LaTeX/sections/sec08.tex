...
produces a topology-specific false vacuum and an anisotropic split structure,
and that the spin-2 quintet splitting and the spin-1 uniaxial mass splitting are
geometrically fixed.  Therefore $\Nilthree$ is positioned as the background
carrying the EC-specific geometric phase structure that is invisible in the LC
version.
