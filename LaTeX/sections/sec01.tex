...
topologies (non-zero background Weyl tensor), and this generates a false vacuum
for $\alpha<0$ via the EC--Weyl coupling (Theorem~6).  The low-energy EFT
around this vacuum is organised through Theorem~7 (quintet splitting) and
Theorem~8 (uniaxial mass splitting).
...
$\Nilthree$ EC vacuum & --- & $r_0=(4\kappa/\!\sqrt{3})\sqrt{|\alpha|}$ (Thm.~6) & \textbf{New} \\
