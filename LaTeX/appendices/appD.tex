...
$\Nilthree$ has non-zero background Weyl and generates an EC slice minimum on
the $\eta=V=0$ section together with
...
\end{equation}
The EC-specific physics of $\Nilthree$ (EC slice minimum, quintet splitting) appears
